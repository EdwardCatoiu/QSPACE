"""
Modified from https://github.com/tctianchi/pyvenn/blob/master/venn.py
"""
...
def venn4(labels, names=['A', 'B', 'C', 'D'], ax = False,fig = False,legend = True,label_text = True,**options):
    """
...
def venn5(labels, names=['A', 'B', 'C', 'D', 'E'], fig = False, ax = False,**options):
    """
